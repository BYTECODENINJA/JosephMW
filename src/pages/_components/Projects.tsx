...
const projects: Project[] = [
    {
        ...
        description: "Full-stack e-commerce platform with cart, payment gateway (Stripe), and admin dashboard.",
    ...
    },
    {
        ...
        description: "Kubernetes cluster monitoring and CI/CD pipeline visualization dashboard.",
        tags: ["Docker", "K8s", "Python"],
